...
class SinhVienListWidget extends StatefulWidget {
  const SinhVienListWidget({Key? key}) : super(key: key);

  @override
  State<SinhVienListWidget> createState() => _SinhVienListWidgetState();
}

class _SinhVienListWidgetState extends State<SinhVienListWidget> {
